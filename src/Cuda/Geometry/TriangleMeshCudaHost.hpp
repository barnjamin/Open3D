...
TriangleMeshCuda& TriangleMeshCuda::Translate(const Eigen::Vector3d& translation) {
    return *this;
}
TriangleMeshCuda& TriangleMeshCuda::Scale(const double scale){
    return *this;
}
TriangleMeshCuda& TriangleMeshCuda::Rotate(const Eigen::Vector3d& rotation,
