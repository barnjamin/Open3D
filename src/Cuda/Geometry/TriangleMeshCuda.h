...
public:
    ...
    TriangleMeshCuda& Translate(const Eigen::Vector3d& translation) override;
    TriangleMeshCuda& Scale(const double scale) override ;
    TriangleMeshCuda& Rotate(const Eigen::Vector3d& rotation,
                               open3d::geometry::Geometry3D::RotationType type = open3d::geometry::Geometry3D::RotationType::XYZ) override;
};
